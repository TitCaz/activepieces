...
export const updatePropalcustomLine = createAction({
  auth: dolibarrAuth,
  name: 'update_propalcustom_line',
  displayName: 'PropalCustom — Modifier une ligne',
  description: 'Modifie une ligne d\'un devis PropalCustom.',
  props: {
