...
export const addSupplierInvoiceLine = createAction({
  auth: dolibarrAuth,
  name: 'add_supplier_invoice_line',
  displayName: 'Facture fournisseur — Ajouter une ligne',
  description: 'Ajoute une ligne à une facture fournisseur.',
  props: {
  ...
  async run(context) {
    ...
    return dolibarrRequest({
      ...
      endpoint: `/supplierinvoices/${id}/lines`,
      body,
    });
  },
});
