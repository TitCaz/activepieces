...
export const listSupplierProposals = createAction({
  auth: dolibarrAuth,
  name: 'list_supplier_proposals',
  displayName: 'Lister les devis fournisseur',
  description: 'Récupère la liste des devis fournisseur.',
  props: {
