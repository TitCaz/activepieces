...
export const addPropalcustomLine = createAction({
  auth: dolibarrAuth,
  name: 'add_propalcustom_line',
  displayName: 'PropalCustom — Ajouter une ligne',
  description: 'Ajoute une ligne à un devis PropalCustom.',
  props: {
  ...
  async run(context) {
    ...
    return dolibarrRequest({
      ...
      endpoint: `/propalscustom/${id}/lines`,
      body,
    });
  },
});
