...
export const listJobPositions = createAction({
  auth: dolibarrAuth,
  name: 'list_job_positions',
  displayName: 'Lister les postes de recrutement',
  description: 'Récupère la liste des postes de recrutement.',
  props: {
  ...
  async run(context) {
    ...
    return dolibarrRequest({
      ...
      endpoint: '/recruitment/jobpositions',
