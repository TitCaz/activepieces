...
export const addPropalLine = createAction({
  auth: dolibarrAuth,
  name: 'add_propal_line',
  displayName: 'Devis — Ajouter une ligne',
  description: 'Ajoute une ligne à un devis.',
  props: {
