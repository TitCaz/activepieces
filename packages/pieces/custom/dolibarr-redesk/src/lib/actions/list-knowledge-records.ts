...
export const listKnowledgeRecords = createAction({
  auth: dolibarrAuth,
  name: 'list_knowledge_records',
  displayName: 'Lister la base de connaissances',
  description: 'Récupère la liste des enregistrements de la base de connaissances.',
  props: {
